...
class Data {
    ...
    /**
     * Util method to build a URL for retriving data from Walmart Labs
     * @param  {String|Number} id The Product ID to retrieve
    ...
    /**
     * Method for persisting current product property to cache
    ...
    /**
     * Helper method for adding product to loacl cache
     * @return {Object} The current object
     */
    ...
    /**
     * Helper method for removing item from local cache
     * @return {Object} The current object
     */
    ...
    /**
     * Helper method for clearing the local cache
     * @return {Object} The current object
     */
    clearProductCache() {
        this.products = {};
    ...
    /**
     * Helper method for logging products
     * @return {Object} The current object
     */
    logProductCache() {
    ...
    /**
     * Helper method for logging product count
     * @return {Object} The current object
     */
    ...
    /**
     * Helper method for logging product IDs
     * @return {Object} The current object
     */
    logProductCacheIds() {
     ...
     * @return {Promise} Products promise
     */
